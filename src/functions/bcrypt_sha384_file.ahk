...
MsgBox % bcrypt_sha384_file("TestFile")
...
bcrypt_sha384_file(filename, bytes := 1048576 , offset := 0, length := -1, encoding := "utf-8")
{
	...
	try
	{
		...
		if (NT_STATUS := DllCall("bcrypt\BCryptOpenAlgorithmProvider", "ptr*", hAlg, "ptr", &BCRYPT_SHA384_ALGORITHM, "ptr", 0, "uint", 0) != 0)
