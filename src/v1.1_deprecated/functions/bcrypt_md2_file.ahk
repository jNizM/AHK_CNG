...
MsgBox % bcrypt_md2_file("TestFile")
; -> 9415bb1a3efd63923944e97c7acc7df2

FileDelete, TestFile



bcrypt_md2_file(filename, bytes := 1048576 , offset := 0, length := -1, encoding := "utf-8")
{
	...
	try
	{
		...
		if (NT_STATUS := DllCall("bcrypt\BCryptOpenAlgorithmProvider", "ptr*", hAlg, "ptr", &BCRYPT_MD2_ALGORITHM, "ptr", 0, "uint", 0) != 0)
